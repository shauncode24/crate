...
/**
 * ReportTabPanel
 * Renders tab selections and details lists for Added, Skipped, Notfound, and Failed items.
 */
export default function ReportTabPanel({ report, activeTab, setActiveTab, onRetry }) {
  ...
  const TABS = [
    { key: 'added', label: 'Added', count: counts.added, color: 'var(--brand)' },
    { key: 'skipped', label: 'Skipped', count: counts.skippedDuplicate, color: 'var(--text-muted)' },
    { key: 'notFound', label: 'Notfound', count: counts.notFound, color: 'var(--warning)' },
